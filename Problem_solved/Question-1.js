...
/**
 * Example Input ["sheep", "sheep", "sheep", "sheep", "sheep", "wolf", "sheep", "sheep"]
 * Example Output // "Oi! Sheep number 2! You are about to be eaten by a wolf!");
 */
...
function warnTheSheep(array) {
  for (let i = 0; i < array.length; i++) {
    if (array[i] == 'sheep') {
      console.log(`Oi! Sheep number 1! You are about to be eaten by a wolf!`)
    } else {
